document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById('btnInternational')
    .addEventListener('click', () => setupBooking('international'));
  document.getElementById('btnDomestic')
    .addEventListener('click', () => setupBooking('domestic'));
  ...
  // Confirmation button → final screen
  document.getElementById('btnCongrats').addEventListener('click', () => {
    showScreen('final');
  });
});
